        ...
        <div className="BetaTest">
            <div className="functions">
                <div className="BetaTestOrder">
                    <Link className="linkLateOrderRecent"to='/BetaTest/recentOrder'><h3 className="subhead3">최신순</h3></Link>
                    <div className="BetaTestOrderBlockLine">|</div>
                    <Link className="linkRecentOrderRecent"to='/BetaTest/lateOrder'><h3 className="subhead3">오래된순</h3></Link>
                </div>
