  ...
  const signInWithGoogle = async () => {
    signInWithPopup(auth, provider).then((result) => {
      ...
      setDoc(doc(db, "userInfo", auth.currentUser.uid), {
        ...
        link: "default.instagram.com/lore",
        scrapPost: [],
        scrapCommunity: [],
      });
      setIsAuth(true);
    ...
    <div className="login">
      <div className="loginTexts">
        ...
        <div className="loginText">
          <h2 className="subhead100">당신을 위한 베타테스트 플랫폼</h2>
        </div>
      </div>
      ...
      <div className="loginFindandSignup">
        <Link to="/Signup" className="loginFindandSignupText">
          <h3 className="subhead100">회원가입</h3>
        </Link>
        <div className="loginBreakLine">|</div>
        <Link to="" className="loginFindandSignupText">
          <h3 className="subhead100">아이디 찾기</h3>
        </Link>
        <div className="loginBreakLine">|</div>
        <Link to="" className="loginFindandSignupText">
          <h3 className="subhead100">비밀번호 찾기</h3>
        </Link>
      </div>
      <div className="loginButtons">
        ...
        >
          <h3 className="subhead100">로그인 하고 시작하기</h3>
        </button>
