        ...
        return (
          <div className="post">
            ...
            <div className="inputAndButton">
              <input  onBlur={(e)=>{var input3 = document.getElementById(post.id+'button');input3.style.borderColor="#E8E8EE"; var input1 = document.getElementById('commentAddInput'+post.id);input1.value='';}} onFocus={(e)=>{var input = document.getElementById(post.id+'button');input.style.borderColor="#2727AD"; input.style.boxSizing="border-box"; input.style.display="block";var input1 = document.getElementById('commentAddInput'+post.id);input1.value='';input1.style.borderRight="none";input1.style.borderTopRightRadius= "0px";input1.style.borderBottomRightRadius="0px";}} id={"commentAddInput"+post.id}onKeyPress={(e)=>{inputPress(e,post.id)}} className="postCommentInput" placeholder="회원님의 의견을 공유해주세요." onChange={(event)=>{setComment(event.target.value);}}/>
