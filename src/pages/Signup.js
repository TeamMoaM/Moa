...
function Signup({ setIsAuth, setList }) {
  ...
  const register = async () => {
    try {
      ...
      await updateDoc(doc(db, "userInfo", "nicknames"), {
        nicknames: arrayUnion(registerNickname),
      });
      ...
      await setDoc(doc(db, "userInfo", auth.currentUser.uid), {
        ...
        introduction: "저에 대한 한 줄 소개입니다.",
        link: "default.instagram.com/lorem",
        scrapPost: [],
        scrapCommunity: [],
      });
      ...
      if (error.message == "Firebase: Error (auth/invalid-email).") {
        ...
        await updateDoc(doc(db, "userInfo", "nicknames"), {
          nicknames: arrayRemove(registerNickname),
        });
      }
    }
  };
    ...
    <div className="signUpBox">
      <div className="signUp">
        <div className="signupTexts">
          <div className="signupBigTitle">
            <h2 className="title150">반갑습니다!</h2>
          </div>
          <div className="signupSmallTitle">
            <h3 className="body150">
              MOA에서 당신의 서비스를 테스트하고
              <br /> 사람들과 함께 의견을 공유해보세요.
            </h3>
          </div>
        </div>
        <div className="signupInputs">
          <div className="emailIDBox">
            <div className="idText">
              <h3 className="subhead100">이메일</h3>
            </div>
            <input
              className="loginID"
              placeholder="예:moa@naver.com"
              onChange={(event) => {
            ...
            {emailCheckBool ? (
              ...
              <div className="registerPasswordFalse">
                사용할 수 없는 이메일입니다.
              </div>
            )}
          </div>
          <div className="nicknameBox">
            <div className="idText">
              <h3 className="subhead100">닉네임</h3>
            </div>
            <input
              className="loginID"
              placeholder="예 : 파란하늘"
          ...
          <div className="passwordBox">
            <div className="idText">
              <h3 className="subhead100">비밀번호</h3>
            </div>
            <input
              className="loginPW"
              type="password"
        ...
        >
          <h3 className="subhead100">회원가입하고 시작하기</h3>
        </button>
      </div>
    </div>
  );
