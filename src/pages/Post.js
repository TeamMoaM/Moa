    ...
    <div className="wrap">
        ...
        <div className="postWrap2">
          <div className="scrapReview2">
            {scrapBool ? (
              ...
              <button onClick={() => scrap()} className="scrap2">
                <div className="scrapFrame">
            ...
            <Link to={link} className="reviewButton2">
              <h3 className="subhead100">리뷰 작성하기</h3>
            </Link>
          </div>
          <div className="postWrapBox">
            <div className="serviceInfo2">
              <img
                className="serviceImgWrap2"
            ...
            <div className="tabList">
              <ul className="tabListItem">
                <button
                  ...
                  className="serviceIntro1"
                >
                  <h3 className="subhead100">서비스 소개</h3>
                </button>
              </ul>
              <ul className="tabListItem">
                <button
      ...
      <div className="postWrap">
        <div className="scrapReview">
          ...
          <Link to={link} className="reviewButton">
            <h3 className="subhead100">리뷰 작성하기</h3>
          </Link>
        </div>
        <div className="postWrapBox">
