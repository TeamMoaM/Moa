      ...
      <div className="createPost">
        <div className="serviceInfo">
          {thumbnailImg ? (
            ...
            <div className="postImgWrap2">
              <label className="input-file-button" for="input-file">
                <img className="cameraImg" src={camera} />
                <h4 className="subhead100">썸네일 등록하기</h4>
              </label>
            </div>
          )}
          <div className="postCon">
            ...
            <div className="userInfo">
              ...
              <h4 className="body100">{user.displayName}</h4>
              <h2 className="caption100">Company name</h2>
            </div>
            <textarea
              maxlength="133"
              className="postIntro"
        ...
        <form onSubmit={formHandeler}>
          <input
            ref={thumbnailInput}
            id="input-file"
            onChange={thumbnailInputOnchange}
          ...
          <button
            ...
            disabled={disabled}
          >
            <h3 className="subhead100">글 등록하기</h3>
          </button>
        </form>
      </div>
